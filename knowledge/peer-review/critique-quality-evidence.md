...
- **The "constructive vs. destructive" literature is mostly normative.** There are commentary papers and training guides; rigorous experimental comparisons of critique styles' effect on author behavior are surprisingly thin. The Sridhar 2025 "EMPATHY framework" paper is one attempt to formalize this; its empirical grounding is preliminary [TODO verify].
